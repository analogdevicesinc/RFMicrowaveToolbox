classdef AXICoreTDD < adi.internal.ControlBase & dynamicprops
    ...
    properties(Constant, Hidden)
            componentChannels = [...
                ...
                struct('name','OffStartRaw',...
                    'default',0,...
                    'type','int',...
                    'attribute','off_raw',...
                    'doc',['%sOffStartRaw %s Off Start in Raw Clock Cycles\n',...
                    'This is this time in clock cylces when the channel will \n',...
                    'transition to the Off state. If same as OnStartRaw,\n',...
                    'output will default to Polarity setting.']...
                ),...
                ...
                struct('name','OnStartRaw',...
                'default',0,...
                'type','int',...
                'attribute','on_raw',...
                'doc',['%sOnStartRaw %s On Start in Raw clock Cycles\n',...
                'This is this time in clock cycles when the channel will \n',...
                'transition to the On state. If same as OffStartRaw,\n',...
                'output will default to Polarity setting.']...
                ),...
                struct('name','Enable',...
                    'default',false,...
