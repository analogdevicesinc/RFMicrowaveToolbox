classdef StingrayTests < HardwareTests
    ...
    methods (Test)
        function testMode(testCase)
            values = cell(size(testCase.sray.ArrayMap, 1));
            values(:) = {'Rx'};            
            values(randi([1 numel(testCase.sray.ArrayMap)], 1, 3)) = {'Tx'};
            values(randi([1 numel(testCase.sray.ArrayMap)], 1, 3)) = {'Disabled'};
            testCase.sray.Mode = values;
        ...
        function testRxEnable(testCase)
            values = logical(randi([0 1], size(testCase.sray.ArrayMap, 1)));
            testCase.sray.RxEnable = values;
            rvalues = testCase.sray.RxEnable;
            testCase.verifyEqual(rvalues,values);
            testCase.sray.RxEnable = logical(false(size(testCase.sray.ArrayMap, 1)));
        end
        ...
        function testTxEnable(testCase)
            ...
            testCase.verifyEqual(rvalues,values);
            testCase.sray.TxEnable = logical(false(size(testCase.sray.ArrayMap, 1)));
        end
        ...
        function testLNABiasOn(testCase)
            values = randi([60 100], size(testCase.sray.ArrayMap, 1))*...
        ...
        function testBiasDACMode(testCase)
            values = cell(size(testCase.sray.ArrayMap, 1));
            values(:) = {'Toggle'};            
            values(randi([1 numel(testCase.sray.ArrayMap)], 1, 3)) = {'On'};
        ...
        function testCommonRxBeamState(testCase)
            values = randi([0 120])*ones(size(testCase.sray.ArrayMap, 1));
        ...
        function testExternalTRPolarity(testCase)
            values = true(size(testCase.sray.ArrayMap, 1));
            testCase.sray.ExternalTRPolarity = values;
            rvalues = testCase.sray.ExternalTRPolarity;
            testCase.verifyEqual(rvalues,values);
            
            values = false(size(testCase.sray.ArrayMap, 1));
            testCase.sray.ExternalTRPolarity = values;
            rvalues = testCase.sray.ExternalTRPolarity;
            testCase.verifyEqual(rvalues,values);
        end
        ...
        function testRxLNABiasCurrent(testCase)
            values = randi([5 8], size(testCase.sray.ArrayMap, 1));
        ...
        function testRxToTxDelay1(testCase)
            values = randi([0 15], size(testCase.sray.ArrayMap, 1));
        ...
        function testRxVGABiasCurrentVM(testCase)
            values = randi([2 5], size(testCase.sray.ArrayMap, 1));
        ...
        function testTxPABiasCurrent(testCase)
            values = randi([3 6], size(testCase.sray.ArrayMap, 1));
